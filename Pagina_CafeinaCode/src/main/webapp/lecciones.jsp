...
<body>
    ...
    <div class="contenedor">
        ...
        <form action="${pageContext.request.contextPath}/lecciones" method="post">
            ...
            <button type="submit">FUNDAMENTOS DE JAVA</button>
        </form>

        <form action="${pageContext.request.contextPath}/lecciones" method="post">
            <input type="hidden" name="accion" value="guardar">
            <input type="hidden" name="id_tema" value="2">
            <input type="hidden" name="descripcion" value="Temas introducctorioas a Java">
            <button type="submit">CONCEPTOS BASICOS</button>
        </form>
    </div>
