...
<body>
    ...
    <div class="contenedor">
        ...
        <p>En este apartado podras acceder a recursos, y herramientas diseñadas para ayudarte a familiarizarte con los conceptos básicos que deberias saber.
        ...
        <form action="${pageContext.request.contextPath}/lecciones" method="post">
            ...
            <input type="hidden" name="descripcion" value="Introducción a Java y algunas dependencias">

            <button type="submit" class="boton boton-fundamentos">
                FUNDAMENTOS DE JAVA
            </button>
        ...
        <form action="${pageContext.request.contextPath}/lecciones" method="post">
            ...
            <input type="hidden" name="descripcion" value="Temas introductorios a Java">

            <button type="submit" class="boton boton-conceptos">
                CONCEPTOS BÁSICOS
            </button>
